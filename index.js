...
.then(recipe => {console.log('Recipe is updated')})
.catch(err =>{console.log('An error is happend again ',err)})
*/
Recipe.deleteOne({title:'Carrot Cake'})
.then(recipe => {console.log('Recipe is deleted')})
.catch(err =>{console.log('An error is happend again ',err)})

mongoose.disconnect('mongodb://localhost/recipeApp', { useNewUrlParser: true })
  .then(() => {
